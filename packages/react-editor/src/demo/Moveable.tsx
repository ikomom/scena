...
import "./App.css";
import {ScenaProps} from "../Editor";
import Editor, {makeScenaFunctionComponent} from "../Editor";

const Badge = makeScenaFunctionComponent("Badge", (props: ScenaProps) => {
  return <p className="badges" data-scena-element-id={props.scenaElementId}>
    <a href="https://www.npmjs.com/package/moveable" target="_blank">
      <img
        src="https://img.shields.io/npm/v/moveable.svg?style=flat-square&amp;color=007acc&amp;label=version"
        alt="npm version"/></a>
    ...
    <a href="https://github.com/daybrush/moveable/tree/master/packages/svelte-moveable"
       target="_blank"><img alt="Svelte"
...
class App extends React.Component {
  ...
  public render() {
    return <div className="app">
      ...
      {/*  <a href="https://daybrush.com/moveable/release/latest/doc"*/}
      {/*     target="_blank">API</a>*/}
      {/*  <a href="https://daybrush.com/moveable/storybook"*/}
  ...
  public componentDidMount() {
    ...
    this.editor.current!.appendJSXs([
      {
        jsx: <div className="moveable" contentEditable="true"
                  suppressContentEditableWarning={true}>可移动</div>,
        name: "标签",
        frame: {
          "position": "absolute",
          "left": "50%",
      ...
      {
        jsx: <div className="moveable" contentEditable="true"
                  suppressContentEditableWarning={true}>Moveable is
          Draggable! Resizable! Scalable! Rotatable! Warpable!
          Pinchable</div>,
        name: "(Description)",
        frame: {
          "position": "absolute",
      ...
      this.editor.current!.setSelectedTargets([targets[1]], true);
    });
